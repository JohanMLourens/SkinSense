...
model_path = 'C:/Users/S_CSIS-Postgrad/Desktop/AI Project/SkinSense/Model/BackUps'

# Define the image size
img_size = (300, 225)  # VGG16 requires an input size of 224x224
model_save_path = os.path.join(model_path, '3_Main_71%_Moadel_VGG.pt')  # Update model filename
# Define classes
